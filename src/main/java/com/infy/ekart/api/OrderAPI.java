...
public class OrderAPI {
	...
	public ResponseEntity<OrderDTO> getOrderDetails(
		...
		List<OrderedProductDTO>orderedProductDTOs=orderDTO.getOrderedProducts();
		for(OrderedProductDTO orderedProduct:orderedProductDTOs) {
			Integer productId = orderedProduct.getProduct().getProductId();//check it once
	...
	public ResponseEntity<List<OrderDTO>> getOrdersOfCustomer(
		...
		for(OrderDTO orderDTO:orderDTOs) {
			List<OrderedProductDTO>orderedProductDTOs=orderDTO.getOrderedProducts();
			for(OrderedProductDTO orderedProduct:orderedProductDTOs) {
				Integer productId = orderedProduct.getProduct().getProductId();
